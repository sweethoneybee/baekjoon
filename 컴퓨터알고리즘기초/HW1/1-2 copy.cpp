...
void minHeapify(pair<int, int> heap[], int i)
{
    while ( true )
    {
        ...
        i = temp;
        // int leftChildValue = 200000;
        // int rightChildValue = 200000;
        // if ( leftChild(i) <= heap[0].second )
        //     leftChildValue = heap[leftChild(i)].first;
        // if ( rightChild(i) <= heap[0].second )
        //     rightChildValue = heap[rightChild(i)].first;
        // if ( heap[i].first <= leftChildValue && heap[i].first <= rightChildValue ) break;

        // if ( heap[i].first > leftChildValue && heap[i].first > rightChildValue )
        // {
        ...
        //     }
        // }
        // else if ( heap[i].first > leftChildValue )
        // {
        //     swap(heap, i, leftChild(i));
        //     i = leftChild(i);
        // }
        // else if ( heap[i].first > rightChildValue )
        // {
        //     swap(heap, i, rightChild(i));
        //     i = rightChild(i);
        // }
